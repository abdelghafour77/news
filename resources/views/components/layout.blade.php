            ...
            <div class="relative flex items-center justify-between h-16">
                ...
                <div class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
                    <div class="flex-shrink-0 flex items-center">
                        <a href="/">
                            <span class="self-center text-xl font-bold whitespace-nowrap dark:text-white">NEWS</span>
                    </div>
                    </a>
                </div>
                <div class="hidden relative md:block object-right">
                    <form method="GET" action="/">
                        ...
                        <input type="text" name="search" value="{{ request('search') }}" id="search-navbar"
                ...
                @guest
                    <div class="hidden sm:block sm:ml-6">
                        <div class="flex space-x-4">
                            ...
                            <a href="/register" class="bg-gray-900 text-white px-3 py-2 rounded-md text-sm font-medium"
                                aria-current="page">
                                Register
                            </a>
